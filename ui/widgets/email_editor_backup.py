...
from ui.styles.stylesheet import (
    ...
    ATTACHMENT_ZONE_STYLE, ATTACHMENT_ITEM_STYLE, ATTACHMENT_ERROR_STYLE,
    SPACING_SMALL, SPACING_MEDIUM, BORDER_RADIUS
)
...
class EmailEditor(QWidget):
    ...
    def create_formatting_toolbar(self):
        ...
        separator.setStyleSheet(f"color: {NEUTRAL_BORDER}; margin: 2px;")
    ...
    def on_text_changed(self):
        ...
        if char_count > self.max_characters:
            ...
            self.char_count_label.setStyleSheet(f"color: {TEXT_SECONDARY}; font-weight: normal;")
